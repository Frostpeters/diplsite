<main class="result">
    <div class="container">
        <div class="result__inner">
            <p class="result__inner-title">{$search_result_title|default:"Result of Search"}</p>
            <div class="result__for">
                {$search_by_const|default:"Поиск произведен по: "}<span>{$search.search_text|default}</span>
            </div>
            <div class="result__site">
                {$search_on_site_const|default:"На сайте: "}<span>{$search.search_site|default}</span>
            </div>
            <div class="result__not-correct">
                {$search_neutral_const|default:"Необработаный результат "}<span>
            ...
            <div class="result__data">
                {if $positive|default}
                    <div class="result__data-inner good">
                        <div class="result__data-title">
                            {$search_positive_result_const|default:"Good results found: "}<span>
                ...
                {if $negative|default}
                    <div class="result__data-inner bad">
                        <div class="result__data-title">
                            {$search_negative_result_const|default:"Bad results found: "}<span>
